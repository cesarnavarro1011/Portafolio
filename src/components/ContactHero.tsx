      ...
      <ul>
        <li className={styles.iconContent}>
          <a href="#" data-social="linkedin">
            ...
            <svg> {/* Aquí iría tu ícono SVG de LinkedIn */} </svg>
          </a>
        ...
        <li className={styles.iconContent}>
          <a href="#" data-social="github">
            <div className={styles.filled}></div>
            <svg> {/* Aquí iría tu ícono SVG de GitHub */} </svg>
          </a>
        ...
        <li className={styles.iconContent}>
          <a href="#" data-social="instagram">
            <div className={styles.filled}></div>
            <svg> {/* Aquí iría tu ícono SVG de Instagram */} </svg>
          </a>
        ...
        <li className={styles.iconContent}>
          <a href="#" data-social="youtube">
            <div className={styles.filled}></div>
            <svg> {/* Aquí iría tu ícono SVG de YouTube */} </svg>
          </a>
